...
dir_daily_data <-  "C:/CADDE_Data/daily_covid_data/"
dir_formatted_case_data <-  "C:/CADDE_Data/COVID_cities/input_data/"
dir_formatted_death_data <-  "C:/CADDE_Data/COVID_cities/input_data/"
...
dir_data_objects <- "C:/CADDE_Data/COVID_cities/input_data/"
